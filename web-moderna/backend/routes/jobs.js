...
function validateCreate (req, res, next) {
    ...
    if (result.success) {
        req.body = result.data // vamos a tener los datos validados y limpios, asignamos al body pq zod tmb permite hacer transformaciones como tolowercase...
        return next()
    }
...
jobsRouter.patch("/", validateUpdate, JobController.partialUpdate)
