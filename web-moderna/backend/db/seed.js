...
const seed = db.transaction(() => {
    ...
    insertJob.run('2', 'Full Stack Developer', 'StartupX', 'Remote', 'Join our team as a full stack developer', 'remote', 'mid')
    insertTech.run('2', 'Node.js')
    insertTech.run('2', 'React')
    insertTech.run('2', 'PostgreSQL')

    insertJob.run('3', 'Junior Backend Developer', 'FinTech Solutions', 'Barcelona, Spain', 'Great opportunity for junior developers', 'onsite', 'junior')
